  ...
  return (
    <div className="md:px-4 grid md:grid-cols-2 gap-4 w-full h-full">
      <div className="w-full h-full relative">
        <video src="/img/games/eldenring.webm" autoPlay loop muted></video>
        <p className="absolute bottom-0 left-1 md:top-0 md:left-1 text-white font-press-start text-xs">
          ELDEN RING
        </p>
      </div>
      <div className="w-full h-full relative">
        <video src="/img/games/cod.webm" autoPlay loop muted></video>
      ...
      <div className="w-full h-full relative">
        {" "}
        <video src="/img/games/csgo.webm" autoPlay loop muted></video>
        <p className="absolute bottom-0 left-1 md:top-0 md:left-1 text-white font-press-start text-xs">
          CS2
        </p>
      </div>
      <div className="w-full h-full relative">
        {" "}
        <video src="/img/games/fh5.webm" autoPlay loop muted></video>
        <p className="absolute bottom-0 left-1 md:top-0 md:left-1 text-white font-press-start text-xs">
          FORZA HORIZON
        </p>
      </div>
