...
const SkillsPage = () => {
  ...
  const containerVariants = {
    ...
    visible: {
      opacity: 1,
      transition: {
        delayChildren: 0.2, // Réduit le délai avant que les enfants commencent à s'animer
        staggerChildren: 0.1,
      },
    },
  };
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col items-center justify-center bg-gradient-to-br from-pink-50 to-purple-50 p-4 overflow-auto">
      <motion.div
        initial="hidden"
        animate="visible"
